  ...
  executeQuery(cursor?: string | null) {
    ...
    const esQuery: any = {
      "aggs": {
        ...
        "Authorities": new ESAggregation("em_source.em_short_label.value.raw")
      },
