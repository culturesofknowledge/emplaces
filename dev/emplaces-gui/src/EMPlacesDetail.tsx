  ...
  createSinglePlace(data: GraphQlData): SinglePlace {
    ...
    if (dataSets[this.dataSetId]) {
      ...
      if (dataSet[this.collection]) {
        ...
        return new SinglePlace(this.getTitle(collection), this.getAlternateNames(collection), this.getCurrentHierarchy(collection));
      }
    }
