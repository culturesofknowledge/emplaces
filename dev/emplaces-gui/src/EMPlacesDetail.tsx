...
export default class EmPlacesDetail extends React.Component<{ match: match<{ uri: string }> }> {
  ...
  private readonly dataSetId = "ue85b462c027ef2b282bf87b44e9670ebb085715d__emplaces_opole20190715";
  private readonly query = "query singlePlace($uri: String!) {\n  dataSets {\n    ue85b462c027ef2b282bf87b44e9670ebb085715d__emplaces_opole20190715 {\n      em_Place(uri: $uri) {\n        em_preferredName {\n          value\n        }\n        title {\n          value\n        }\n        em_alternateNameList {\n          items {\n            ... on Value {\n              value\n            }\n          }\n        }\n        em_hasRelationList {\n          items {\n            ...recursiveRelation\n          }\n        }\n        em_settingList {\n          items {\n            em_location {\n              ... on ue85b462c027ef2b282bf87b44e9670ebb085715d__emplaces_opole20190715_em_Location_value {\n                title {\n                  value\n                }\n                wgs84_pos_lat {\n                  value\n                }\n                wgs84_pos_long {\n                  value\n                }\n              }\n            }\n            em_when {\n              ... on ue85b462c027ef2b282bf87b44e9670ebb085715d__emplaces_opole20190715_em_Time_period {\n                rdfs_label {\n                  value\n                }\n                em_timespanList {\n                  items {\n                    em_latestStart {\n                      value\n                    }\n                    em_earliestEnd {\n                      value\n                    }\n                  }\n                }\n              }\n            }\n          }\n        }\n        em_source {\n          ... on ue85b462c027ef2b282bf87b44e9670ebb085715d__emplaces_opole20190715_em_Authority {\n            title {\n              value\n            }\n          }\n        }\n      }\n    }\n  }\n}\n\nfragment recursiveRelation on ue85b462c027ef2b282bf87b44e9670ebb085715d__emplaces_opole20190715_em_Qualified_relation {\n  ...relationFields\n  em_relationTo {\n    ...relatedPlace\n    ... on ue85b462c027ef2b282bf87b44e9670ebb085715d__emplaces_opole20190715_em_Place {\n      em_hasRelationList {\n        items {\n          ...relationFields\n          em_relationTo {\n            ...relatedPlace\n            ... on ue85b462c027ef2b282bf87b44e9670ebb085715d__emplaces_opole20190715_em_Place {\n              em_hasRelationList {\n                items {\n                  ...relationFields\n                  em_relationTo {\n                    ...relatedPlace\n                    ... on ue85b462c027ef2b282bf87b44e9670ebb085715d__emplaces_opole20190715_em_Place {\n                      em_hasRelationList {\n                        items {\n                          ...relationFields\n                          em_relationTo {\n                            ...relatedPlace\n                            ... on ue85b462c027ef2b282bf87b44e9670ebb085715d__emplaces_opole20190715_em_Place {\n                              em_hasRelationList {\n                                items {\n                                  ...relationFields\n                                  em_relationTo {\n                                    ...relatedPlace\n                                    ... on ue85b462c027ef2b282bf87b44e9670ebb085715d__emplaces_opole20190715_em_Place {\n                                      em_hasRelationList {\n                                        items {\n                                          ...relationFields\n                                          em_relationTo {\n                                            ...relatedPlace\n                                            ... on ue85b462c027ef2b282bf87b44e9670ebb085715d__emplaces_opole20190715_em_Place {\n                                              em_hasRelationList {\n                                                items {\n                                                  ...relationFields\n                                                  em_relationTo {\n                                                    ...relatedPlace\n                                                    ... on ue85b462c027ef2b282bf87b44e9670ebb085715d__emplaces_opole20190715_em_Place {\n                                                      em_hasRelationList {\n                                                        items {\n                                                          ...relationFields\n                                                          em_relationTo {\n                                                            ...relatedPlace\n                                                            ... on ue85b462c027ef2b282bf87b44e9670ebb085715d__emplaces_opole20190715_em_Place {\n                                                              em_hasRelationList {\n                                                                items {\n                                                                  ...relationFields\n                                                                  em_relationTo {\n                                                                    ...relatedPlace\n                                                                    ... on ue85b462c027ef2b282bf87b44e9670ebb085715d__emplaces_opole20190715_em_Place {\n                                                                      em_hasRelationList {\n                                                                        items {\n                                                                          ...relationFields\n                                                                          em_relationTo {\n                                                                            ...relatedPlace\n                                                                            ... on ue85b462c027ef2b282bf87b44e9670ebb085715d__emplaces_opole20190715_em_Place {\n                                                                              em_hasRelationList {\n                                                                                items {\n                                                                                  ...relationFields\n                                                                                  em_relationTo {\n                                                                                    ...relatedPlace\n                                                                                  }\n                                                                                }\n                                                                              }\n                                                                            }\n                                                                          }\n                                                                        }\n                                                                      }\n                                                                    }\n                                                                  }\n                                                                }\n                                                              }\n                                                            }\n                                                          }\n                                                        }\n                                                      }\n                                                    }\n                                                  }\n                                                }\n                                              }\n                                            }\n                                          }\n                                        }\n                                      }\n                                    }\n                                  }\n                                }\n                              }\n                            }\n                          }\n                        }\n                      }\n                    }\n                  }\n                }\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n}\n\nfragment relationFields on ue85b462c027ef2b282bf87b44e9670ebb085715d__emplaces_opole20190715_em_Qualified_relation {\n  em_relationType {\n    title {\n      value\n    }\n  }\n  em_when {\n    rdfs_label {\n      value\n    }\n    em_timespanList {\n      items {\n        em_latestStart_ {\n          value\n        }\n        em_earliestEnd_ {\n          value\n        }\n      }\n    }\n  }\n}\n\nfragment relatedPlace on ue85b462c027ef2b282bf87b44e9670ebb085715d__emplaces_opole20190715_em_Place {\n  title {\n    value\n  }\n  em_preferredName {\n    value\n  }\n  em_placeCategory {\n    ... on ue85b462c027ef2b282bf87b44e9670ebb085715d__emplaces_opole20190715_skos_Concept {\n      rdfs_labelList {\n        items {\n          value\n        }\n      }\n    }\n  }\n}";
  uri: string;
  state: {
    data: SinglePlace
  };
