...
Our intent is to prepare the gazetteer in a transparent and collaborative manner as possible to allow it to become a useful resource for for the early modern community and an active participant in the proposed [Pelagios][8] network. In support of this, in addition to CSV, Excel, and RDF-Turtle, EM Places will support the export of structured data in the new Geo-JSON [Linked Places Interconnection Format][4]. 
